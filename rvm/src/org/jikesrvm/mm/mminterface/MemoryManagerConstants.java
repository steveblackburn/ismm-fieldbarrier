...
public class MemoryManagerConstants {
  ...
  public static final boolean USE_PREFIX_FIELD_MARKS_FOR_SCALARS = Selected.Constraints.get().usePrefixFieldMarksForScalars();
  public static final boolean USE_PREFIX_FIELD_MARKS_FOR_ARRAYS = Selected.Constraints.get().usePrefixFieldMarksForArrays();
}
