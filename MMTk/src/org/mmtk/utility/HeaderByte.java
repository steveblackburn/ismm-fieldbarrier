...
import static org.mmtk.plan.Plan.FIELD_BARRIER_USE_GC_BYTE;
...
public class HeaderByte {
  ...
  public static final int FIELD_BARRIER_LOW_BIT = FIELD_BARRIER_USE_GC_BYTE ? UNLOGGED_BIT_NUMBER + 1 : -1;
  public static final int FIELD_BARRIER_HIGH_BIT = FIELD_BARRIER_USE_GC_BYTE ? 7 : -1;
  public static final int USED_GLOBAL_BITS = FIELD_BARRIER_USE_GC_BYTE ? FIELD_BARRIER_HIGH_BIT : UNLOGGED_BIT_NUMBER;
